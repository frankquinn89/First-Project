...
$sql="INSERT INTO student (FIRST_NAME, SURNAME, DOB, ADDRESS, EMAIL, PHONE_NUM, PASSWORD, GENDER)
VALUES
('$_POST[FIRST_NAME]','$_POST[SURNAME]','$_POST[DOB]','$_POST[ADDRESS]','$_POST[EMAIL]','$_POST[PHONE_NUM]'
,'$_POST[COURSE_ID]''$_POST[PASSWORD]','$_POST[GENDER]')";
...
<br>
<br>
<p><a href=AddStudent2.html> RETURN </a></p>